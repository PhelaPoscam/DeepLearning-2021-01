...
class MinMaxGame:
    ...
    def _updateRecord(self):
        ...
        handle = open('/content/drive/MyDrive/License-super-resolution-master2/Log/' + self.now + '.json', 'w')
        json.dump(self.log, handle)
        handle = open('/content/drive/MyDrive/License-super-resolution-master2/Val/' + self.now + '.json', 'w')
